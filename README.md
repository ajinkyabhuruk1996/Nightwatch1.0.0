...
Refer Ajinkya - for nightwatch.conf.js file and setup   https://medium.freecodecamp.org/how-to-easily-start-automatically-testing-your-website-8629ea8df04a?gi=219c101dc926
Git Repo URL: git clone https://github.com/nightwatchjs/nightwatch.git

Ajinkya run below commands
1.   npm install --save-dev nightwatch
2.   npm install --save-dev selenium-server
2.   npm install --save-dev chromedriver geckodriver

Ajinkya - Inside package.json scripts you will find below command
"nightwatch": "nightwatch -c tests/nightwatch.conf.js -e chrome"

Also you will find tests folder and a newly written nightwatch.conf.js
and features folder which will contain tests to be executed.
Example-  google.test.js

Also Note: nightwatch project name should be changed in package.json
